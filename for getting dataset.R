...
Sys.setenv(SPOTIFY_CLIENT_ID = "a91f0715d4a940f698e2e8113b767887")
# Check the value of SPOTIFY_CLIENT_ID
  # Check the value of SPOTIFY_CLIENT_SECRET
Sys.setenv(SPOTIFY_CLIENT_SECRET = "4ab22a77ade74b64a359df3508bf49cb")


#access_token <- get_spotify_access_token(client_id = Sys.getenv('a91f0715d4a940f698e2e8113b767887'),
 #                                        client_secret = Sys.getenv('4ab22a77ade74b64a359df3508bf49cb'))
